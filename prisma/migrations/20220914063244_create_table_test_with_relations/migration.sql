...
-- AddForeignKey
ALTER TABLE "Test" ADD CONSTRAINT "Test_teachersDisciplineId_fkey" FOREIGN KEY ("teachersDisciplineId") REFERENCES "TeachersDiscipline"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
